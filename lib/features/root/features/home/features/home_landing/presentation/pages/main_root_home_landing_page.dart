...
class MainRootHomeLandingPage extends HookConsumerWidget {
  const MainRootHomeLandingPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(translations.dashboard, key: const Key(WidgetKeys.dashboardText),),
        actions: const [
          ButtonSettings()
        ],
      ),
