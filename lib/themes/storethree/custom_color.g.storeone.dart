...
@Injectable(as: ICustomColorsContainer, env: [
  "${Env.production}_${Stores.storeThreeName}",
  "${Env.staging}_${Stores.storeThreeName}",
  "${Env.local}_${Stores.storeThreeName}",
  "${Env.test}_${Stores.storeThreeName}"
])
class CustomColorsContainerStoreThree implements ICustomColorsContainer {
  @override
